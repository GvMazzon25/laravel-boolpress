...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getFilms: function getFilms() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://localhost:8000/api/film?page=".concat(page)).then(function (res) {
        console.log(res);
        _this.films = res.data.data;
        _this.pagination = {
    ...
    getExept: function getExept(text, maxLength) {
    ...
    formatDate: function formatDate(filmDate) {
      var date = new Date(filmDate);
        ...
        ? _c(
            ...
            [
              _vm._l(_vm.films, function (film) {
                return _c(
                  "article",
                  { key: "film-" + film.id, staticClass: "mb-4" },
                  [
                    _c("h2", [_vm._v(_vm._s(film.name))]),
                    _vm._v(" "),
                    _c("div", { staticClass: "mb-4" }, [
                      _vm._v(_vm._s(_vm.formatDate(film.created_at))),
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "mb-4" }, [
                      _vm._v(_vm._s(_vm.getExept(film.cast, 100))),
                    ]),
                  ]
                )
              }),
                ...
                "button",
                {
                  ...
                  on: {
                    click: function ($event) {
                      return _vm.getFilms(_vm.pagination.current - 1)
                    },
                  },
                },
                [_vm._v("\r\n           Prev\r\n       ")]
...
module.exports = __webpack_require__(/*! C:\Users\gvmaz\OneDrive\Desktop\Corso-Boolean\Corso-WD\laravel-boolpress\resources\js\front-office.js */"./resources/js/front-office.js");
